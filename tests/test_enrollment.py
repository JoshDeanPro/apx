...
class EnrollmentStoreTests(unittest.TestCase):
    ...
    def test_manual_mode_leaves_pending(self):
        record=self.store.request(machine_id="machine:mac",runtime="claude",mode="manual")
        self.assertEqual(record["status"],"pending")

    def test_disabled_mode_refuses_request(self):
        with self.assertRaises(EnrollmentError): self.store.request(machine_id="machine:mac",runtime="claude",mode="disabled")
    ...
    def test_automatic_mode_only_applies_when_explicitly_requested(self):
        ...
        manual=self.store.request(machine_id="machine:mac",runtime="claude",mode="manual")
        self.assertEqual(manual["status"],"pending")
        automatic=self.store.request(machine_id="machine:mac",runtime="claude",mode="automatic")
    ...
    def test_list_filters_by_status(self):
        a=self.store.request(machine_id="m",runtime="claude")
    ...
    def test_persists_across_instances(self):
        record=self.store.request(machine_id="machine:mac",runtime="claude")
