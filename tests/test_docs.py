...
[projects.context]
architecture=["Single service on the server."]
...
class DocsTests(unittest.TestCase):
    ...
    def test_machine_audience_includes_related_missions(self):
        result=self.cloud.run("mission.create",actor="human:operator",project="demo",title="Fix bug",objective="Repair the thing")
    ...
    def test_docs_action_is_shared_across_python_and_cli_path(self):
        result=self.cloud.run("docs.generate",actor="human:operator",project="demo",audience="machine")
