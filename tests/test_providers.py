...
class ProviderSchemaTests(unittest.TestCase):
    ...
    def test_generated_component_is_descriptive_and_scoped(self):
        ...
        self.assertEqual(definition.required_permissions,("network:horoscope.example",))
...
class ProviderLifecycleTests(unittest.TestCase):
    ...
    def test_real_prepare_execute_verify_receipt_and_reverse(self):
        ...
        self.assertIn("action.prepared",names); self.assertIn("action.authorization_required",names); self.assertIn("action.completed",names)
    ...
    def test_auth_expiry_replay_and_revocation(self):
        ...
        self.assertEqual(outcome.status,"authorization_required")
        ...
        self.assertTrue(first.ok); self.assertEqual(replay.status,"authorization_required")
